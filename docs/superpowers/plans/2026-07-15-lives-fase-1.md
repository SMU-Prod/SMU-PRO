...
A migration também habilita RLS nas três tabelas, com policies de SELECT restritas a live aberta (`live_events`, `live_messages`); `live_attendance` fica sem nenhuma policy, travada só para `service_role`.
