...
// getCourseSplitConfig, registerCommission e cancelCommissionByEnrollment foram
// movidas para @/lib/commissions (módulo interno sem "use server"): registrar
// comissão e ler a wallet do parceiro não podem ser endpoints HTTP públicos.
