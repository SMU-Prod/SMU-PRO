...
❌ Inventar dados falsos — se não souber o dado exato, diga "na minha experiência..."`,
    ...
    await supabase.from("activity_log").insert({
      ...
      tipo: "system" as any,
      descricao: `AI explain: ${tokensUsed} tokens (~$${estimatedCost.toFixed(4)})`,
      metadata: { lesson_id: lessonId, tokens: tokensUsed, model: "gpt-4.1-mini", estimated_cost_usd: estimatedCost },
    });
